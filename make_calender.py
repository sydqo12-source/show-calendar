...
def push_to_github():
    ...
    try:
        ...
        try:
            subprocess.run(["git", "commit", "-m", "Update calendar (SPA Final)"], check=True)
...
def main():
    ...
    try:
        ...
        # 2. 날짜 파싱 (년, 월, 일 추출 for JavaScript)
        def parse_date(x):
            try:
                # 2026.01.20(화)... 형식
        ...
        if not df.empty:
            ...
            start_month = int(df[df['Year'] == start_year]['Month'].min())
        else:
            start_year = 2026
            start_month = 1
...
<body class="initial-mode">
    <div class="header-container">
        ...
        <div class="title-wrap">
            ...
            <div class="sub-title" id="calendar-title">2026년 1월</div>
        </div>
